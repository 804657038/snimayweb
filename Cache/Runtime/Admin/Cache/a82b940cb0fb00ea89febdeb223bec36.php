...
.clcl:hover{color:#ff0000;}
    ...
    <div class="column_Box mainAutoHeight">
        ...
        <div class="wrapBox mainAutoHeight">
            ...
            <div class="body User">
                <div class="item">
                    <a href="javascript:void(0);" class="dot_Item"><span class="Icon_item icon_xingjian"></span><i><input type="button" value="添加产品" class="submitNoBg" onclick="window.location.href='<?php echo U('Goods/add',array('cat_id'=>$_GET['cat_id']));?>'"/></i></a>
                    <div class="searchBar">
						<form action="<?php echo U('Goods/index');?>">
							...
							<select name="sort_by" class="dot_Item">
								...
								<!-- <option value="a.type" <?php if($filter["sort_by"] == 'a.type'): ?>selected=""<?php endif; ?>>推荐产品</option>
								<option value="a.goods_id" <?php if($filter["sort_by"] == 'a.goods_id'): ?>selected=""<?php endif; ?>>产品编号</option> -->
								<option value="a.title" <?php if($filter["sort_by"] == 'a.title'): ?>selected=""<?php endif; ?>>产品标题</option>
								<option value="ac.cat_name" <?php if($filter["sort_by"] == 'ac.cat_name'): ?>selected=""<?php endif; ?>>产品分类</option>
					...
					<table border="0" cellpadding="0" cellspacing="0" class="center">
						...
						<tbody>
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
								...
								<td><img src="__ROOT__/<?php echo ($vo["goods_img"]); ?>" width="110" height="80"></td>
