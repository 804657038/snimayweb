...
function delAds(id) {
    ...
    <div class="column_Box mainAutoHeight">
        ...
        <div class="wrapBox mainAutoHeight">
            ...
            <div class="body User">
                <div class="item">
                    <a href="javascript:void(0);" class="dot_Item"><span class="Icon_item icon_xingjian"></span><i><input type="button" value="新建广告图" class="submitNoBg" onclick="window.location.href='<?php echo U('Ads/add');?>'"/></i></a>
                    <form action="<?php echo U('Ads/index');?>" method="get" style="float: right;">
                        <label>广告图分类：</label>
                        <select name="cat_id">
                            <?php echo ($data); ?>
                        </select>
