...
<div class="column_Box mainAutoHeight">
    ...
    <div class="column_Box mainAutoHeight wrapBox">
        <div class="body">
            <form method="post" action="<?php echo U('Service/update_contact');?>" id="submitForm" name="submitForm" enctype="multipart/form-data">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tbody>

                    <tr>
                        <td style="text-align:right;">标题：</td>
                        <td style="text-align:left;"><input type="text" name="title" value="<?php echo ($info["title"]); ?>" size="35" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;"><textarea cols="37" rows="5" name="content"><?php echo ($info["content"]); ?></textarea></td>
                    </tr>
