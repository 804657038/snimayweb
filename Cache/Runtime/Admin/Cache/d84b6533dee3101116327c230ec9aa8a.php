				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: ">
                                <input type="radio" name="cat_style" value="1" <?php if($cat["cat_style"] == 1): ?>checked<?php endif; ?>/>旧版
                                <input type="radio" name="cat_style" value="2" <?php if($cat["cat_style"] == 2): ?>checked<?php endif; ?>/>新版
                            </td>
                        </tr>
						<tr>
						...
						<tr>
							...
							<td style="text-align:left;"><input type="text" class="txt" value="<?php echo ($cat["title"]); ?>" name="title"  /> 	关键字为选填项，其目的在于方便外部搜索引擎搜索</td>
						</tr>
