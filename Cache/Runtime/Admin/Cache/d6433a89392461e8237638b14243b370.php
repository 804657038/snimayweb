...
function delRecruitment(id) {
	$.dialog.confirm('你确定要删除这个属性吗？', function(){
		window.location.href="<?php echo U('Goodsgro/del');?>/id/"+id;
	}, function(){
		//$.dialog.tips('执行取消操作');
	});
}
    ...
    <div class="column_Box mainAutoHeight">
        ...
        <div class="wrapBox mainAutoHeight">
            ...
            <div class="body User">
            	<div class="item">
                   <a href="javascript:void(0);" class="dot_Item"><span class="Icon_item icon_xingjian"></span><i><input type="button" value="添加属性" class="submitNoBg" onclick="window.location.href='<?php echo U('Goodsgro/add');?>'"/></i></a>
                   <div class="searchBar">
						<form action="<?php echo U('Goodsgro/index');?>">
							所属分类：
				...
				<form method="POST" action="<?php echo U('Goodsgro/batch');?>" name="listForm">
					<table border="0" cellpadding="0" cellspacing="0" class="center">
						...
						<tbody>
							<?php if(is_array($recruitmentList)): foreach($recruitmentList as $key=>$vo): ?><tr>
								...
								<th><?php echo ($vo["cat_name"]); ?></th>
								<th><?php echo ($vo["title"]); ?></th>
								<th><?php echo ($vo["sort_order"]); ?></th>
								<td>
									<span>
										<a title="查看详情" href="<?php echo U('Goodsgro/edit',array('id'=>$vo['id']));?>"><img width="16" height="16" border="0" src="__PUBLIC__/Admin/Img/icon_edit.gif"></a>&nbsp;
