...
<script type="text/javascript">
    function delRecruitment(id) {
        $.dialog.confirm('你确定要删除这个吗？', function(){
            window.location.href="<?php echo U('Goodsmesa/del');?>/id/"+id;
        }, function(){
            //$.dialog.tips('执行取消操作');
        });
    }
...
<div class="column_Box mainAutoHeight">
    <div class="tab">
        <ul>
            <li class="current"><a href="javascript:">台面列表</a></li>
        </ul>
    </div>
    <div class="wrapBox mainAutoHeight">
        ...
        <div class="body User">
            <div class="item">
                <a href="javascript:void(0);" class="dot_Item"><span class="Icon_item icon_xingjian"></span><i><input type="button" value="添加台面" class="submitNoBg" onclick="window.location.href='<?php echo U('Goodsmesa/add');?>'"/></i></a>
                <div class="searchBar">
            ...
            <form method="POST" action="<?php echo U('Goodscolor/batch');?>" name="listForm">
                <table border="0" cellpadding="0" cellspacing="0" class="center">
                    ...
                    <?php if(is_array($recruitmentList)): foreach($recruitmentList as $key=>$vo): ?><tr>
                            <td><input type="checkbox" name="checkboxes[]" class="checkBox_list" value="<?php echo ($vo["goods_id"]); ?>" /><?php echo (intval($vo["id"])); ?></td>

                            <th><?php echo ($vo["title"]); ?></th>
                            <th><img src="__ROOT__/<?php echo ($vo["img"]); ?>" width="64" height="21" style="top:5px;position:relative"></th>
                            <!-- <th><?php echo ($vo["sort_order"]); ?></th> -->
                            <td>
									<span>
										<a title="查看详情" href="<?php echo U('Goodsmesa/edit',array('id'=>$vo['id']));?>"><img width="16" height="16" border="0" src="__PUBLIC__/Admin/Img/icon_edit.gif"></a>&nbsp;
										<a title="移除" onclick="delRecruitment('<?php echo (intval($vo["id"])); ?>')" href="javascript:;"><img width="16" height="16" border="0" src="__PUBLIC__/Admin/Img/icon_drop.gif"></a>
									</span>
                            </td>
