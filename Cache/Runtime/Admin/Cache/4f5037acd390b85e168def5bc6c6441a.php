...
function challs_flash_update(){ //Flash 初始化函数
  ...
  a.url="__PUBLIC__/Tool/update.php"; 
  //设置服务器接收代码文件
  
  a.parameter="bs=tyi&id=<?php echo ($id); ?>&thumb_width=210&thumb_height=210";
  //设置提交参数，以GET形式提交
...
<div class="column_Box mainAutoHeight">
  <div class="tab">
    <ul>
      <li class="current"><a href="javascript:">产品图片（相册）</a></li>
    </ul>
  </div>
  <div class="column_Box mainAutoHeight wrapBox">
        <div class="body">

          <form method="post" action="<?php echo U('Goods/updateGoodsimg');?>" name="theForm" enctype="multipart/form-data">
          <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
              <td class="label">产品图片(相册)</td>
              <td colspan="3" class="show">
                <?php if(empty($goodsimg_list)): ?>暂无
                <?php else: ?>
                  <?php if(is_array($goodsimg_list)): foreach($goodsimg_list as $key=>$list): ?><div id="img<?php echo ($list["id"]); ?>">
                      <img src="__ROOT__/<?php echo ($list["thumb_img"]); ?>" /><br/>
                      排序：<input type="text"  value="<?php echo ($list["sort_order"]); ?>" name="new_img_sort[]" size="3" /><br/>
                      <input type='hidden' name='old_img_id[]' value='<?php echo ($list["id"]); ?>'/>
                      <a href="javascript:imgdel(<?php echo ($list["id"]); ?>)" onclick="return confirm('您确定要删除这张图片吗？');">[删除]</a>
            ...
            <tr>
              ...
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align='left'>
                    <td>
                      <font color='red' size='-1'>图片尺寸：955px * 600px</font><br/><br/>
            ...
            <tr>
              ...
              <td>
                ...
                <style>
                #show div{float:left;padding:9px;text-align:center;border: 1px solid #DADADA; margin: 10px;}
                .show div{float:left;padding:9px;text-align:center;border: 1px solid #DADADA; margin: 10px;}
                #show img,.show img{height:120px;}
                </style>
              </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td align="left"><br />
                <input type='hidden' name='id' value='<?php echo ($detail["goods_id"]); ?>'>
