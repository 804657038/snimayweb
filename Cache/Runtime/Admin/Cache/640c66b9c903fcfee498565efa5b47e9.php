			...
			<form method="post" action="<?php echo U('Articlecat/insert');?>" id="submitForm" name="submitForm" enctype="multipart/form-data">
				<table border="0" cellpadding="0" cellspacing="0">
					<tbody>
                        ...
                        <tr>
                            <td style="text-align: right">内容编辑页样式：</td>
                            <td style="text-align: ">
                                <input type="radio" name="cat_style" value="1" checked />旧版
                                <input type="radio" name="cat_style" value="2" />新版
                            </td>
                        </tr>
						<tr>
						...
						<tr>
							...
							<td style="text-align:left;"><input type="text" class="txt" value="" name="title"  /> 	关键字为选填项，其目的在于方便外部搜索引擎搜索</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="text-align:left;"><input type="text" class="txt" value="" name="link"  /></td>
						</tr>
						<tr>
							<td style="text-align:right;">手机端链接：</td>
							<td style="text-align:left;"><input type="text" class="txt" value="" name="link2"  /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td style="text-align:left;">
