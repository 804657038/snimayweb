...
<div class="column_Box mainAutoHeight">
    ...
    <div class="column_Box mainAutoHeight wrapBox">
        <div class="body">
            <form method="post" action="<?php echo U('Goodsmesa/update');?>" id="submitForm" name="submitForm" enctype="multipart/form-data">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                    <tr>
                        <td style="text-align:right;">属性名称：</td>
                        <td style="text-align:left;"><input type="text" class="txt" name="title" value="<?php echo ($info["title"]); ?>" size='80'/></td>
                    </tr>
                    <?php if(!empty($info['img'])): ?><tr>
                            <td style="text-align:right;">图片预览：</td>
                            <td style="text-align:left;"><img src="__ROOT__/<?php echo ($info["img"]); ?>" style='max-height:300px; margin-left:10px; margin-top:5px'/></td>
                        </tr><?php endif; ?>
                    <tr>
                        <td style="text-align:right;">产品图片：</td>
                        <td style="text-align:left;">
                            <input type='file' name='img'/>&nbsp;&nbsp;&nbsp;<font color='red'>64px * 21px</font>
                        </td>
                    </tr>
