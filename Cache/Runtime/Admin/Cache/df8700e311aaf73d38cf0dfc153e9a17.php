...
<div class="column_Box mainAutoHeight">
    ...
    <div class="column_Box mainAutoHeight wrapBox">
        <div class="body">
            <form method="post" action="<?php echo U('Ads/update_cat');?>" id="submitForm" name="submitForm" enctype="multipart/form-data">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;"><input type="text" value="<?php echo ($list["catname"]); ?>" name="catname" size="35" /><em>*</em></td>
                    </tr>
